...
const AdminScreen: React.FC<AdminScreenProps> = ({
  ...
  const updateSettings = useCallback(() => {
    ...
    if (currentStages.length > 0) {
      onSettingsChange({ selectedStages: currentStages, speed, isRandomMode, numStages, showHands });
    }
  }, [selectedGroups, speed, isRandomMode, numStages, showHands, onSettingsChange]);
